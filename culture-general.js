   ...
   "features":[
      ...
      },
      {
         ...
         "properties":{
            ...
            "startDate":[50, "d.C."],
            "endDate":[600, "d.C."],
            "period":["Horizonte Temprano"],
            "description":"Nazca es una cultura arqueológica del Antiguo Perú que se desarrolló básicamente en los valles del actual departamento de Ica, alrededor del siglo I y entró en decadencia en el siglo VII. Su centro estaba ubicado en Cahuachi, en el margen izquierdo del Río Grande, en la actual provincia de Nazca. Su territorio llegó a abarcar y su desde Chincha por el norte, hasta Arequipa por el sur. Hasta el siglo VI d. C., aumentaron sus contactos con la zona andina, llegando inclusive hasta las zonas altas de Ayacucho. Este contacto tuvo especial importancia en la formación de la cultura Huari.",
      ...
      },
      {
         ...
         "properties":{
            ...
            "startDate":[200, "d.C."],
            "endDate":[1470, "d.C."],
            "period":["Intermedio Temprano","Horizonte Medio","Intermedio Tardío"],
            "description":"La cultura Cajamarca es una cultura preincaica que surgió en los Andes del norte del Perú, cercano a la ciudad de Cajamarca, del cual toma su nombre.1Toda la zona de Cajamarca estuvo dominada por estilos similares a Chavín durante el primer milenio a. C.; de esto quedan como vestigios los sitios arqueológicos de Kuntur Wasi y Pacopampa,2​ pero es a partir del siglo III d. C. y hasta el IX d. C. (Intermedio Temprano) en que la cultura Cajamarca alcanza el mayor nivel artesanal formando un estilo propio.",
      ...
      },
      {
         ...
         "properties":{
            ...
            "description":"Cultura Tiahuanaco, se pronuncia tiwanaku, es la denominación de una cultura arqueológica que se expandió en los actuales países de Bolivia, Argentina, Perú y Chile entre los años 1580 a. C. y 1187 d. C. Su área de influencia, visible en objetos con una peculiar iconografía, comprende la cuenca del lago Titicaca como región nuclear, desde donde se distribuye hacia los valles y costa del océano Pacífico por el oeste, la región del Chapare por el este y el altiplano boliviano meridional y el oasis de San Pedro de Atacama por el sur. Su capital y principal centro religioso fue la ciudad de Tiwanaku, ubicada en las riberas del río homónimo, pocos kilómetros al sur del lago Titicaca, en el actual departamento boliviano de La Paz.",
      ...
      },
      {
         ...
         "properties":{
            ...
            "endDate":[1470, "d.C."],
            "period":["Intermedio Temprano","Horizonte Medio","Intermedio Tardío"],
            "description":"Chachapoyas es una cultura arqueológica del Antiguo Perú que se desarrolló en el actual departamento peruano de Amazonas a finales del Horizonte Medio y durante todo el periodo Intermedio Tardío. Ha dejado un número importante de grandes monumentos de piedra, como la llacta de Kuélap, el Gran Pajatén, edificaciones funerarias, sarcófagos y mausoleos como los de la Laguna de los Cóndores y otros lugares de difícil acceso. Esta cultura fue un conjunto de desarrollo de comunidades autónomas.",
      ...
      },
      {
         ...
         "properties":{
            ...
            "startDate":[1200, "d.C."],
            "endDate":[1470, "d.C."],
            "period":["Horizonte Tardío"],
            "description":"La civilización Chancay fue una civilización preincaica que se desarrolló entre los valles de Fortaleza, Pativilca, Supe, Huaura, Chancay, Chillón, Rímac y Lurín, en la costa central del Perú, entre los años 1200 y 1470 d. C. que corresponde al Intermedio Tardío. Su centro se ubicó a 80 kilómetros al norte de Lima. Se trata de una ubicación territorial básicamente desértica, pero con valles fértiles bañados por ríos y ricos en recursos, que permitieron, entre otros, un alto desarrollo de la agricultura. El comercio que desarrolló la civilización Chancay con otras regiones fue intenso y permitió contactar con otras culturas y poblados en un área extendida. La cultura Chancay decayó en el siglo XV para dar paso territorial a sus conquistadores provenientes del Imperio Inca.",
